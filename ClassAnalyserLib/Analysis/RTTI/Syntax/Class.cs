...
namespace ClassAnalyser.Analysis.RTTI.Syntax
{
    public class Class
    {
        ...
        public string GetHierarchyInfo()
        {
            ...
            if (IsBaseClass)
                result.AppendLine(BaseClassDescriptor.ToString());
            ...
            RecurseBaseClasses(this);

            return result.ToString();
        }

        public string ToHeader(bool in_isWatermark = true)
        {
            ...
            if (in_isWatermark)
            {
                return $"""
                /*
                    Generated by Class Analyser (https://github.com/hyperbx/ClassAnalyser)

                    Class Hierarchy;
                    {GetHierarchyInfo().Replace("\n", "\n    ").Trim()}
                */
